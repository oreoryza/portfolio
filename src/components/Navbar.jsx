  ...
  return (
    <>
      <nav className="absolute top-0 w-screen h-24 flex justify-between z-50">
        <div className="flex gap-4">
          <button
            ...
            className={`group border border-t-0 border-l-0 w-12 ${
        ...
        <div className="flex items-center gap-2 pr-6 select-none">
          <button
            ...
            disabled={theme === "dark"}
            className={`${
              theme === "dark" ? "" : "text-white opacity-50"
            } duration-300`}
          >
          ...
          <button
            ...
            className={`${
              theme === "dark" ? "opacity-50" : "text-white"
            } duration-300`}
          >
      ...
      >
        ...
        <button onClick={() => setIsHamburger(false)} className={`group absolute bottom-0 left-0 flex justify-center items-center border-t ${theme==="dark" ? "border-black" : "border-white"} w-full md:h-24 h-16`}>
